...
if TYPE_CHECKING:
    ...
    VLLM_DEEPSEEK_V4_DIRECT_PAGED_PREFILL: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_DEEPSEEK_V4_DIRECT_PAGED_PREFILL": lambda: bool(
        int(os.getenv("VLLM_DEEPSEEK_V4_DIRECT_PAGED_PREFILL", "0"))
    ),
